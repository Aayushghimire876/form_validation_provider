          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == '' || value == null) {
                    return 'Name cannot rbe empty'; //we are passing the error here
                  } else if (!context.read<FormProvider>().userNameCorrection(
                    value,
                  )) {
                ...
                onChanged: (value) {
                  context.read<FormProvider>().setUserName(value);
                },
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  } else if (!context.read<FormProvider>().emailCorrection(
                    value,
                  )) {
                ...
                onChanged: (value) {
                  context.read<FormProvider>().setEmail(value);
                },
                decoration: InputDecoration(
                  hintText: 'Email',
                  border: OutlineInputBorder(),
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  } else if (!context.read<FormProvider>().passwordCorrection(
                    value,
                  )) {
                    return "Enter Capital letter first";
                ...
                onChanged: (value) {
                  context.read<FormProvider>().setPassword(value);
                },
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  } else if (!context.read<FormProvider>().phoneCorrection(
                    value,
                  )) {
                ...
                onChanged: (value) {
                  context.read<FormProvider>().setPhoneNumber(value);
                },
                decoration: InputDecoration(
              ...
              ElevatedButton(
                onPressed: () {
                  if (context.read<FormProvider>().validateForm()) {
